...
class UserPreferences(Base):
    ...
    visa_preference = Column(String, default="visa_free")
...
class ItineraryActivity(Base):
    ...
    id = Column(String, primary_key=True, default=generate_uuid)
    day_id = Column(String, ForeignKey("itinerary_days.id"))
    title = Column(String, nullable=False)
...
class ResearchJob(Base):
    ...
    job_type = Column(String, nullable=False)  # 'destination_research', 'comparison', 'itinerary'
